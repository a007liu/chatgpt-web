...
import { NDropdown, NText, useDialog } from 'naive-ui'
...
<template>
		...
		<div class="flex items-center px-4 py-2 border-b">
			...
			<div class="flex-1 flex items-center justify-end">
				...
				<NDropdown class="user-drop" :options="options" show-arrow @select="handleSelect">
					<UserAvatar :isUserName="!isMobile"/>
				</NDropdown>
			</div>
		</div>
	...
	<UserInfo v-if="showUserInfo" v-model:visible="showUserInfo"></UserInfo>
	<Password v-if="showPassword" v-model:visible="showPassword"></Password>
