...
import { NDrawer, NButton, NInput, NSpin, useMessage } from 'naive-ui'
...
<template>
	<NDrawer v-model:show="show" height="600px" placement="bottom" :close-on-esc="false" :mask-closable="false">
		<div class="flex flex-col h-full">
			<P class="py-4 text-xl text-[#000] font-bold text-center">个人信息</P>
			<div class="px-4">
				<div class="mb-6">
					<p class="text-[#000] font-bold mb-2">{{ $t('setting.oldPassword') }}</p>
					<div class="">
						<NInput
							type="password"
				...
				<div class="mb-6">
					<p class="text-[#000] font-bold mb-2">{{ $t('setting.newPassword') }}</p>
					<div class="">
						<NInput
							type="password"
				...
				<div class="mb-6">
					<p class="text-[#000] font-bold mb-2">{{ $t('setting.confirmNewPassword') }}</p>
					<div class="">
						<NInput
							type="password"
